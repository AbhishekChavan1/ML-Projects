...
def predict(): 
     if request.method == 'POST':        
            ...
            if ( prediction[0] == 1):return render_template('index.html', prediction_text= 'Result: Malignant')
            else:return render_template('index.html', prediction_text= 'Result: Benign')
