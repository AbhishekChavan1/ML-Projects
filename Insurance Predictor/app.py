...
def predict():  
     if request.method == 'POST':
            ...
            if(PrevIns == 'yesPrevIns'):PrevIns = 1
            else:PrevIns = 0

            VehDam = request.form['damageBox']
            if(VehDam == 'yesDam'):VehDam = 1
            else:VehDam = 0
            ...
            if ( prediction[0] == 1):return render_template('index.html', prediction_text= 'The customer will buy the insurance')
            else:return render_template('index.html', prediction_text= 'The customer will not buy the insurance')
