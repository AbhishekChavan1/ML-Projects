...
def predict(): 
     if request.method == 'POST':
            ...
            if (prediction[0] > 0.5):return render_template('index.html', prediction_text='RESULTS:  Loan Approved')
            else:return render_template('index.html', prediction_text= 'RESULTS:  Loan Rejected')
