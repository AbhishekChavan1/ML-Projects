...
def predict():
    if request.method == 'POST':
            ...
            if(Cholesterol_Status == 'cholesterolHigh'):Cholesterol_Status = 1
            else:Cholesterol_Status = 0	
            ...
            return render_template('index.html', prediction_text= 'Predicted Drug is ' + prediction[0])
